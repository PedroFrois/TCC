...
A Figura \ref{fig:metodologia} ilustra as etapas da metodologia para o desenvolvimento do trabalho proposto dividida em 04 (quatro) atividades: pesquisa (1); avaliação (3); descrição da avaliação (5); avaliação final (7). Tais atividades resultam em 04 (quatro) artefatos - lista de boas práticas para arquitetura de software (2); base para descrição da arquitetura (4); proposta de arquitetura (6); e a arquitetura final com observações da avaliação (8).
...
\begin{enumerate}
    ...
    Para a pesquisa com foco na procura de arquitetura de \textit{software} foram utilizadas referências recomendadas pela orientadora e pelo coorientador deste trabalho, além de uma pesquisa ampla utilizando a ferramenta Google Scholar. 
