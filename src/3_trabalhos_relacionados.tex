...
Tabian (2021) realizou um trabalho prático a fim de responder a pergunta se \textit{Kotlin Multiplataform Mobile (KMM)} está pronto para ser utilizado em produção. Para atingir seu objetivo ele se propôs desenvolver o mesmo aplicativo tanto para Android quanto para iOS compartilhando certa parte do código fonte utilizando o KMM. 

Além disso seu trabalho listou todas as tecnologias que utilizou para o desenvolvimento e, ao final do projeto, deu seu parecer sobre elas. Segundo ele algumas bibliotecas utilizadas pelo KMM ainda não possuem uma base de usuários consolidada, então ao enfrentar problemas com elas o desenvolvedor terá que, muito provavelmente, resolvê-los por conta própria.

Em sua conclusão, apesar de ter enfrentado alguns problemas de configurações iniciais, Tabian (2021) afirma que KMM pode ser utilizado para desenvolvimento de aplicações que visam entrar em produção, visto que conseguiu desenvolver uma aplicação Android e iOS que utilizam KMM e que estão disponíveis para \textit{download} nas lojas oficiais da Google e Apple. \cite{kmmReadyForProduction}
...
Finalizando com o trabalho de Tabian (2021). Seu trabalho tem caráter exploratório e não defende as escolhas para suas decisões arquiteturais. Além disso, não foi feito utilizando metologia científica já que não possuia objetivos acadêmicos.


%==================================================================================================================

Em suma, os trabalhos relacionados deixam de lado uma boa justificativa e descrição teórica para motivar o uso da arquitetura escolhida. O presente trabalho diferencia-se dos outros uma vez que irá abordar com mais detalhes a arquitetura, a qual terá seu desenvolvimento fundamentado em literaturas já consolidadas e conhecidas pelo meio acadêmico e pelo mercado.