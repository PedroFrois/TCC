...
Portanto, é de fácil compreensão o motivo dessa linguagem ser a recomendada para o desenvolvimento de aplicações nativas Android em detrimento do Java. Somado a esse fato, o novo framework Kotlin Multiplatform Mobile (KMM) que objetiva o desenvolvimento de aplicações móveis multiplataforma está cada vez mais robusto e já é utilizado em ferramentas internas por empresas como: Philips, Autodesk, Netflix, entre outros \cite{multiplataformaKotlinMultiplatform}.
