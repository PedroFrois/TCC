...
O presente trabalho visa contribuir para solucionar um dos desafios encontrados no desenvolvimento de aplicação multiplataforma, especificamente quanto à Arquitetura de Software. O objetivo do trabalho é descrever uma arquitetura de software que possa viabilizar o desenvolvimento de aplicações móveis que compartilham código entre as plataformas Android e iOS.
