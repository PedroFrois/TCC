...
\begin{enumerate}
    \item \textit{Domain}: análago ao Model da arquitetura MVVM e utilizando-se dos princípios da Arquitetura Limpa, ele é o módulo central da arquitetura, de forma que deverá ser totalmente independente da plataforma de implementação. Com isso, ele poderá sem completamente intercambiável entre Android e iOS, de modo que consistirá na representação da multiplataforma nessa arquitetura.
