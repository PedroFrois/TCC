...
Para evitar implementações diferentes em cada app, as regras de negócio deverão pertencer à parte compartilhada do código. 

Ex: Uma plataforma faz a validação para ver se o usuário possui credencial de acesso a uma certa funcionalidade, enquanto outra plataforma esquece dessa implementação.
